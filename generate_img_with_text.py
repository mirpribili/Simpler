...
base = [
	...
	('city',0,0),#подлежащее
	('it',0,0),#подлежащее
	('spider',0,0),#подлежащее
	('learning_English',0,0),#подлежащее
	...
	("had","orange",0),#will
	("might","orange",0),#will
	("may_might_could","orange",0),#will
	("should_must_can't","orange",0),#will
	("would","orange",0),#will
	("'d","orange",0),#will
