...
base = [
	...
	# GREEN
	("disappeared","#22a221", 0),# сказуемое

	("гл-в-СОВЕРШ-Й ф","#22a221", 0),# сказуемое
	("locked","#22a221", 0),#will
	("try","#22a221", 0),# сказуемое
	("turned on","#22a221", 0),# сказуемое
	...
	("сказуемое","#22a221", 0),# сказуемое

	("have","#22a221", 0),# сказуемое

	("have-has","#22a221", 0),# сказуемое

	("sweam","#22a221", 0),# сказуемое

	("take","#22a221", 0),# сказуемое

	("глагол_","#22a221", 0),# сказуемое
	("глагол(-ed)","#22a221", 0),# сказуемое
	("touchED","#22a221", 0),# сказуемое

	("we", 0, 0),#подлежащее

	("they", 0, 0),#подлежащее

	("was","#22a221", 0),# сказуемое

	("be","#22a221", 0),# сказуемое

	("wasn't","#22a221", 0),# сказуемое

	("weren't","#22a221", 0),# сказуемое
	...
	# PURPL
	("even","#C354FF", 0),# сказуемое
	("perhaps","#C354FF", 0),# сказуемое
